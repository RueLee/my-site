...
export function ResumePDFButton() {
  return (
    <Link href="/pdfs/Ruleon Lee Resume - December 2024.pdf" target="_blank" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-gray-500 rounded-xl group">
